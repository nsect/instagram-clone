...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // Create a post and add to firestor 'posts' collection
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                <XIcon
                  ...
                  className="absolute h-5 top-1 right-2 cursor-pointer"
                />
                {selectedFile ? (
                  <img
                  ...
                  <div
                    ...
                    className="mx-auto flex items-center justify-center h-12 w-12 bg-red-100 cursor-pointer"
                  >
                    <CameraIcon
